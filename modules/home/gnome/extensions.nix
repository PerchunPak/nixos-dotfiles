  ...
  dconf.settings =
    ...
    in
    {
      ...
      "org/gnome/shell/extensions/dash-to-panel" = {
        ...
        animate-appicon-hover-animation-convexity = toGvariantDict {
          RIPPLE = 2.0;
          PLANK = 1.0;
          SIMPLE = 0.0;
        };
        animate-appicon-hover-animation-duration = toGvariantDict {
          SIMPLE = mkUint32 160;
          RIPPLE = 130;
          PLANK = 100;
        };
        animate-appicon-hover-animation-extent = toGvariantDict {
          RIPPLE = 4;
          PLANK = 4;
          SIMPLE = 1;
        };
        animate-appicon-hover-animation-rotation = toGvariantDict {
          SIMPLE = 0;
          RIPPLE = 10;
          PLANK = 0;
        };
        animate-appicon-hover-animation-travel = toGvariantDict {
          SIMPLE = 0.12;
          RIPPLE = 0.4;
          PLANK = 0.0;
        };
        animate-appicon-hover-animation-type = "SIMPLE";
        animate-appicon-hover-animation-zoom = toGvariantDict {
          SIMPLE = 1.11;
          RIPPLE = 1.25;
          PLANK = 2.0;
        };
